      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto animate-fade-in-up delay-100">
            Empowering innovation through collaboration and open-source
            contributions.
          </p>
          <button
      ...
      <section className="py-16 bg-[#1a1a1a]/50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { icon: Users, label: "Participants", value: "65" },
              { icon: Github, label: "Projects", value: "7" },
              { icon: Code2, label: "Contributions", value: "22" },
      ...
      <section className="py-20 bg-[#1a1a1a]">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-gray-300">
            <p>
              Welcome to the SVCE Learners Platform, where we are dedicated to
              fostering a culture of collaboration, innovation, and continuous
              learning. Our mission is to empower students to contribute to and
              harness the potential of open-source technologies, creating a
              space where creativity, problem-solving, and knowledge-sharing
              thrive.
            </p>
            <p>
              At SVCE, we believe that open-source projects play a critical role
              in shaping the future of technology. They enable collaborative
              efforts among developers worldwide, driving innovation, advancing
              new solutions, and encouraging the growth of an open digital
              ecosystem. By engaging in these projects, students gain hands-on
              experience, improve their technical skills, and have the
              opportunity to make meaningful contributions to the global tech
              community.
            </p>
            <p>
              Platforms like GitHub serve as a hub for these collaborations.
              Here, students can share their work, collaborate with like-minded
              individuals, and build solutions that are open for anyone to use,
              enhance, and evolve. This spirit of openness and shared
              development fosters an environment where ideas can flourish,
              skills can grow, and technology can continue to advance.
            </p>
            <p className="font-semibold text-[#7ed957]">
              Join us at SVCE Learners Platform and become part of a vibrant
              community driving innovation through open-source contributions!
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                description:
                  "All open-source organizations, Project maintainers are welcome to mentor budding open-source enthusiasts from all different backgrounds. Find students and professionals that have skills and share your vision.",
                icon: Code2,
              ...
              },
              {
                title: "Mentor",
                description:
                  "Are you an expert in one (or more) of the projects? Then be a beacon of light for our participants! As a mentor, you will guide one team with your insights and experience all through their Open Source & Hackathon journey.",
                icon: Github,
